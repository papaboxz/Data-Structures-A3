...
Author:   Linda Crane, Emmett Janssens
Course:   CST8130 - Data Structures
Data members:   
		 address: String - hold the value of a valid email address
Methods: EmailAddress() - default constructor - set empty string field
         ...
         compareAddresses(EmailAddress) - Takes in an email address and compares the names of the two email addresses
                   						  and returns the result. (Written by Emmett Janssens)
*************************************************************************************/
...
public class EmailAddress {
	...
	public int compareAddresses (EmailAddress rightEmailAddress)
	{
		return this.address.compareTo(rightEmailAddress.address);
	}
